...
type Props = NativeStackScreenProps<RootStackParamList, 'LoginCode'>

export default function LoginCodeScreen({ navigation, route }: Props) {
  ...
  const verify = async () => {
    ...
    try {
      ...
      if (profile) {
        ...
        // Email exists in auth but no profile — send through signup
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <View style={styles.content}>
            ...
            <View style={styles.body}>
              ...
              <Pressable onPress={resend} disabled={resendCooldown > 0}>
                <Text style={resendCooldown > 0 ? styles.resendDisabled : styles.resendText}>
...
const styles = StyleSheet.create({
  ...
  helperText: { fontSize: 13, color: '#A8A3B8', textAlign: 'center' },
  helperLink: { color: '#4A4458', textDecorationLine: 'underline' },
})
